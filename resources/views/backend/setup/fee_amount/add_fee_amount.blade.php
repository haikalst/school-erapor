                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Tambah Harga Pembayaran</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        <div class="card">
            <div class="card-header">
                <strong>Tambah Harga Pembayaran</strong>
            </div>
            <div class="card-body card-block">
                <form method="post" action="{{ route('fee.amount.store') }}" class="form-horizontal">
                    @csrf
                    <div class="add-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="amount" name="amount[]" placeholder="Harga"
                                        class="form-control">
                                </div>
                            </div>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <button type="submit" class="btn btn-info">
                                <i class="fa fa-floppy-o"></i>&nbsp; Simpan Harga
                            </button>
                        </div>
                    </div>
                </form>
