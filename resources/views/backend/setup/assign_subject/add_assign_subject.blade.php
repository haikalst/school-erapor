                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Tambah Nilai Mata Pelajaran</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        <div class="card">
            <div class="card-header">
                <strong>Tambah Nilai Mata Pelajaran</strong>
            </div>
            <div class="card-body card-block">
                <form method="post" action="{{ route('assign.subject.store') }}" class="form-horizontal">
                    @csrf
                    <div class="add-item">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <button type="submit" class="btn btn-info">
                                <i class="fa fa-floppy-o"></i>&nbsp; Simpan Nilai Mata Pelajaran
                            </button>
                        </div>
                    </div>
                </form>
