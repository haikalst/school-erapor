    ...
    <div class="content">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form method="post" action="{{ route('student.year.update', $editData->id) }}" class="form-horizontal">
                    @csrf
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="name" name="name"
                                placeholder="Tahun Ajaran" class="form-control" value="{{ $editData->name }}">
                            @error('name')
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <button type="submit" class="btn btn-info">
                                <i class="fa fa-floppy-o"></i>&nbsp; Edit Tahun Ajaran
                            </button>
                        </div>
                    </div>
                </form>
